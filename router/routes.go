				...
				response := model.IntentResponse{
					...
					Data: map[string]interface{}{
						"StripeCreateCharge": map[string]string{
							...
							"PageData":    "sk_test_yourstripetestkey",
					...
					response := model.IntentResponse{
						...
						Data: map[string]interface{}{
							"StripeCreateSubscription": map[string]string{
								"plan":   "plan_123",
								"apiKey": "sk_test_yourstripetestkey",
								"Endpoint": "http://localhost:8075/test/success/true",
							},
						},
					}
					...
					response := model.IntentResponse{
						...
						Data: map[string]interface{}{
							"SlackSendNotification": map[string]string{
								"text":    "new purchase",
								"channel": "general",
								"apiKey":  "xoxp-388044397831-386300920016-466668367249-51325125125125125",
								"Endpoint": "http://localhost:8075/test/success/true",
							},
						},
					}
					...
					response := model.IntentResponse{
						...
						Data: map[string]interface{}{
							"SlackSendNotification": map[string]string{
								"text":    "new purchase",
								"channel": "general",
								"apiKey":  "xoxp-388044397831-386300920016-466668367249-41241241241241241241241241",
								"Endpoint": "http://localhost:8075/test/success/true",
							},
							"StripeCreateCharge": map[string]string{
								"Email":       "youremail@gmail.com",
