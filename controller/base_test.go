...
func TestBase(t *testing.T) {
	...
	c.Request, _ = http.NewRequest("POST", "/", bytes.NewBufferString(`{"intentFunctions":{"1":"Stripe","2":"Slack"},"intentData":{"Stripe":{"Amount":"1999","Email":"youremail@gmail.com","Title":"Title of Payment"},"Slack":{"API":"slack_ck4chs7","Notification":"Hello world!"}}}`))
